...
import { getBuildingType, createBuildingType, deleteBuildingType } from '../../../services/nomenclature-service'
            ...
            <div>
                <div className="row">
                    <div className="col-lg-4">
                        <h2><strong>Добавете тип строителство</strong></h2>
                    </div>
                </div>
                <hr />
                <div className="row">
