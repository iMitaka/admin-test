...
import { getOfferType, createOfferType, deleteOfferType } from '../../../services/nomenclature-service'
import { Link } from 'react-router-dom'

export default class OfferType extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Name: '',
            ...
            <div>
                <div className="row">
                    <div className="col-lg-4">
                        <h2><strong>Добавете тип оферта</strong></h2>
                    </div>
                </div>
                <hr />
                <div className="row">
