...
import { getPropertyStatus, createPropertyStatus, deletePropertyStatus } from '../../../services/nomenclature-service'
import { Link } from 'react-router-dom'

export default class PropertyStatus extends Component {
    constructor(props) {
        super(props);
        this.state = {
            Name: '',
    ...
    save() {
        createPropertyStatus(this.state)
            .then(res => res.text())
            .then((result) => {
                console.log(result)
                this.loadAll();
            ...
            <div>
                <div className="row">
                    <div className="col-lg-4">
                        <h2><strong>Добавете статус на имот</strong></h2>
                    </div>
                </div>
                <hr />
                <div className="row">
